...
(function (u) {
    ...
    A(u, "parts-3d/Math.js", [u["parts/Globals.js"]], function (b) {
        ...
        b.perspective = function (v, r, n) {
            var y = r.options.chart.options3d, g = n ? r.inverted : !1,
                ...
                p = r.scale3d || 1, k = z * y.beta * (g ? -1 : 1), y = z * y.alpha * (g ? -1 : 1), a = Math.cos(y),
                f = Math.cos(-k), q = Math.sin(y), h = Math.sin(-k);
            ...
            return v.map(function (m) {
                ...
                var c = (g ? m.x : m.y) - t.y;
                m = (m.z || 0) - t.z;
                e = {x: f * e - h * m, y: -q * h * e + a * c - f * q * m, z: a * h * e + q * c + a * f * m};
                c = b.perspective3D(e,
                    t, t.vd);
                c.x = c.x * p + t.x;
                c.y = c.y * p + t.y;
    ...
    A(u, "parts-3d/SVGRenderer.js", [u["parts/Globals.js"]], function (b) {
        ...
        var x = Math.cos, v = Math.PI, r = Math.sin, n = b.animObject, y = b.charts, g = b.color, t = b.defined,
            p = b.deg2rad, k = b.extend, a = b.merge, f = b.perspective, q = b.pick, h = b.SVGElement,
        ...
        w = b.merge(c, {
            parts: ["front", "top", "side"], pathType: "cuboid", attr: function (a, c, d, e) {
                ...
                return a.shapeArgs || t(a.x) ? this.singleSetterForParts("d", null, this.renderer[this.pathType + "Path"](a.shapeArgs || a)) : h.prototype.attr.call(this,
                    a, void 0, d, e)
            }, animate: function (a, c, d) {
                t(a.x) && t(a.y) ? (a = this.renderer[this.pathType + "Path"](a), this.singleSetterForParts("d", null, a, "animate", c, d), this.attr({zIndex: a.zIndexes.group})) : h.prototype.animate.call(this, a, c, d);
                return this
        ...
        b.SVGRenderer.prototype.cuboidPath = function (a) {
            ...
            var d = a.x, e = a.y, l = a.z, h = a.height, m = a.width, k = a.depth, q = y[this.chartIndex], p, w,
                g = q.options.chart.options3d.alpha, n = 0,
                r = [{x: d, y: e, z: l}, {x: d + m, y: e, z: l}, {x: d + m, y: e + h, z: l}, {
                    x: d,
                    y: e + h,
                    z: l
                }, {x: d, y: e + h, z: l + k}, {x: d + m, y: e + h, z: l + k}, {x: d + m, y: e, z: l + k}, {
                    x: d,
                    y: e,
                    z: l + k
        ...
        b.SVGRenderer.prototype.arc3d = function (c) {
            ...
            d.attr = function (a) {
                ...
                return h.prototype.attr.apply(d,
                    arguments)
            };
            d.animate = function (c, l, f) {
                var m, k = this.attribs, p, w = "data-" + Math.random().toString(26).substring(2, 9);
                delete c.center;
                delete c.z;
                delete c.depth;
                delete c.alpha;
                ...
                return h.prototype.animate.call(this,
                    c, l, f)
            };
            d.destroy = function () {
                this.top.destroy();
        ...
        m.prototype.arc3dPath = function (a) {
            ...
            var d = a.x, e = a.y, l = a.start,
                b = a.end - .00001, f = a.r, m = a.innerR || 0, h = a.depth || 0, k = a.alpha, p = a.beta,
                q = Math.cos(l), w = Math.sin(l);
            a = Math.cos(b);
            var g = Math.sin(b), n = f * Math.cos(p), f = f * Math.cos(k), t = m * Math.cos(p), y = m * Math.cos(k),
                m = h * Math.sin(p), u = h * Math.sin(k), h = ["M", d + n * q, e + f * w],
                h = h.concat(z(d, e, n, f, l, b, 0, 0)), h = h.concat(["L", d + t * a, e + y * g]),
                h = h.concat(z(d, e, t, y, b, l, 0, 0)), h = h.concat(["Z"]), A = 0 < p ? Math.PI / 2 : 0,
                p = 0 < k ? 0 : Math.PI / 2, A = l > -A ? l : b > -A ? -A : l,
                C = b < v - p ? b : l < v - p ? v - p : b, D = 2 * v - p, k = ["M", d + n * x(A), e + f * r(A)],
            ...
            k = k.concat(["L", d + n * Math.cos(C) + m, e + f * Math.sin(C) +
            u]);
    ...
    A(u, "parts-3d/Chart.js", [u["parts/Globals.js"]], function (b) {
        function u(b, k) {
            var a = b.plotLeft, f = b.plotWidth + a, p = b.plotTop, h = b.plotHeight + p, m = a + b.plotWidth / 2,
                e = p + b.plotHeight / 2, c = Number.MAX_VALUE, w = -Number.MAX_VALUE, l = Number.MAX_VALUE,
                E = -Number.MAX_VALUE, d, g = 1;
            d = [{x: a, y: p, z: 0}, {x: a, y: p, z: k}];
        ...
        g(v.prototype, "renderSeries", function (b) {
            ...
            if (this.is3d()) for (; k--;) b =
                this.series[k], b.translate(), b.render(); else b.call(this)
        });
        x(v, "afterDrawChartBox", function () {
            if (this.is3d()) {
                var p = this.renderer, k = this.options.chart.options3d, a = this.get3dFrame(), f = this.plotLeft,
                    q = this.plotLeft + this.plotWidth, h = this.plotTop, m = this.plotTop + this.plotHeight,
                    k = k.depth, e = f - (a.left.visible ? a.left.size : 0),
                    c = q + (a.right.visible ? a.right.size : 0), w = h - (a.top.visible ? a.top.size : 0),
                ...
                this.frameShapes.bottom[n]({
                    ...
                    faces: [{
                        ...
                        {
                            fill: b.color(a.bottom.color).brighten(.1).get(),
                            vertexes: [{x: f, y: m, z: k}, {x: q, y: m, z: k}, {x: q, y: m, z: 0}, {x: f, y: m, z: 0}],
                            enabled: a.bottom.visible
                        }, {
                            fill: b.color(a.bottom.color).brighten(-.1).get(),
                            vertexes: [{x: e, y: l, z: g}, {x: e, y: l, z: d}, {x: f, y: m, z: k}, {x: f, y: m, z: 0}],
                            enabled: a.bottom.visible && !a.left.visible
                        }, {
                            fill: b.color(a.bottom.color).brighten(-.1).get(),
                            vertexes: [{x: c, y: l, z: d}, {x: c, y: l, z: g}, {x: q, y: m, z: 0}, {x: q, y: m, z: k}],
                            ...
                            fill: b.color(a.bottom.color).get(),
                            vertexes: [{x: e, y: l, z: d}, {x: c, y: l, z: d}, {x: q, y: m, z: k}, {x: f, y: m, z: k}],
                ...
                this.frameShapes.top[n]({
                    ...
                    faces: [{
                        ...
                        {
                            fill: b.color(a.top.color).brighten(.1).get(),
                            vertexes: [{x: f, y: h, z: 0}, {x: q, y: h, z: 0}, {x: q, y: h, z: k}, {x: f, y: h, z: k}],
                            enabled: a.top.visible
                        }, {
                            fill: b.color(a.top.color).brighten(-.1).get(),
                            vertexes: [{x: e, y: w, z: d}, {x: e, y: w, z: g}, {x: f, y: h, z: 0}, {x: f, y: h, z: k}],
                            enabled: a.top.visible && !a.left.visible
                        }, {
                            fill: b.color(a.top.color).brighten(-.1).get(),
                            vertexes: [{x: c, y: w, z: g}, {x: c, y: w, z: d}, {x: q, y: h, z: k}, {x: q, y: h, z: 0}],
                            enabled: a.top.visible && !a.right.visible
                        }, {
                            fill: b.color(a.top.color).get(),
                            vertexes: [{x: e, y: w, z: g},
                                {x: c, y: w, z: g}, {x: q, y: h, z: 0}, {x: f, y: h, z: 0}],
                            enabled: a.top.visible && !a.front.visible
                        }, {
                            fill: b.color(a.top.color).get(),
                            vertexes: [{x: c, y: w, z: d}, {x: e, y: w, z: d}, {x: f, y: h, z: k}, {x: q, y: h, z: k}],
                ...
                this.frameShapes.left[n]({
                    ...
                    faces: [{
                        ...
                        vertexes: [{x: e, y: l, z: g}, {x: f, y: m, z: 0}, {x: f, y: m, z: k}, {x: e, y: l, z: d}],
                        enabled: a.left.visible && !a.bottom.visible
                    },
                        {
                            fill: b.color(a.left.color).brighten(.1).get(),
                            vertexes: [{x: e, y: w, z: d}, {x: f, y: h, z: k}, {x: f, y: h, z: 0}, {x: e, y: w, z: g}],
                            ...
                            fill: b.color(a.left.color).brighten(-.1).get(),
                            vertexes: [{x: f, y: h, z: k}, {x: f, y: m, z: k}, {x: f, y: m, z: 0}, {x: f, y: h, z: 0}],
                            enabled: a.left.visible
                        }, {
                            ...
                            vertexes: [{x: e, y: w, z: d}, {x: e, y: l, z: d}, {x: f, y: m, z: k}, {x: f, y: h, z: k}],
                ...
                this.frameShapes.right[n]({
                    ...
                    faces: [{
                        ...
                        vertexes: [{x: c, y: l, z: d}, {x: q, y: m, z: k}, {x: q, y: m, z: 0}, {x: c, y: l, z: g}],
                        enabled: a.right.visible && !a.bottom.visible
                    },
                        {
                            fill: b.color(a.right.color).brighten(.1).get(),
                            vertexes: [{x: c, y: w, z: g}, {x: q, y: h, z: 0}, {x: q, y: h, z: k}, {x: c, y: w, z: d}],
                            enabled: a.right.visible && !a.top.visible
                        }, {
                            fill: b.color(a.right.color).brighten(-.1).get(),
                            vertexes: [{x: q, y: h, z: 0}, {x: q, y: m, z: 0}, {x: q, y: m, z: k}, {x: q, y: h, z: k}],
                            ...
                            vertexes: [{x: c, y: l, z: d}, {x: c, y: w, z: d}, {x: q, y: h, z: k}, {x: q, y: m, z: k}],
                ...
                this.frameShapes.back[n]({
                    ...
                    faces: [{
                        ...
                        vertexes: [{x: c, y: l, z: d}, {x: e, y: l, z: d}, {x: f, y: m, z: k}, {x: q, y: m, z: k}],
                        enabled: a.back.visible && !a.bottom.visible
                    },
                        {
                            fill: b.color(a.back.color).brighten(.1).get(),
                            vertexes: [{x: e, y: w, z: d}, {x: c, y: w, z: d}, {x: q, y: h, z: k}, {x: f, y: h, z: k}],
                            enabled: a.back.visible && !a.top.visible
                        }, {
                            fill: b.color(a.back.color).brighten(-.1).get(),
                            vertexes: [{x: e, y: l, z: d}, {x: e, y: w, z: d}, {x: f, y: h, z: k}, {x: f, y: m, z: k}],
                            enabled: a.back.visible && !a.left.visible
                        }, {
                            fill: b.color(a.back.color).brighten(-.1).get(),
                            vertexes: [{x: c, y: w, z: d}, {x: c, y: l, z: d}, {x: q, y: m, z: k}, {x: q, y: h, z: k}],
                            enabled: a.back.visible && !a.right.visible
                        }, {
                            fill: b.color(a.back.color).get(),
                            vertexes: [{x: f, y: h, z: k}, {x: q, y: h, z: k}, {x: q, y: m, z: k}, {x: f, y: m, z: k}],
                ...
                this.frameShapes.front[n]({
                    ...
                    faces: [{
                        ...
                        {
                            fill: b.color(a.front.color).brighten(.1).get(),
                            vertexes: [{x: c, y: w, z: g}, {x: e, y: w, z: g}, {x: f, y: h, z: 0}, {x: q, y: h, z: 0}],
                            enabled: a.front.visible && !a.top.visible
                        }, {
                            fill: b.color(a.front.color).brighten(-.1).get(),
                            vertexes: [{x: e, y: w, z: g}, {x: e, y: l, z: g}, {x: f, y: m, z: 0}, {x: f, y: h, z: 0}],
                            enabled: a.front.visible && !a.left.visible
                        }, {
                            fill: b.color(a.front.color).brighten(-.1).get(),
                            vertexes: [{x: c, y: l, z: g}, {x: c, y: w, z: g}, {x: q, y: h, z: 0}, {x: q, y: m, z: 0}],
                            enabled: a.front.visible && !a.right.visible
                        }, {
                            fill: b.color(a.front.color).get(),
                            vertexes: [{x: q, y: h, z: 0}, {x: f, y: h, z: 0}, {x: f, y: m, z: 0}, {x: q, y: m, z: 0}],
        ...
        v.prototype.retrieveStacks = function (b) {
            var k = this.series, a = {}, f, g = 1;
            this.series.forEach(function (h) {
                f = y(h.options.stack, b ? 0 : k.length - 1 - h.index);
                a[f] ? a[f].series.push(h) : (a[f] = {series: [h], position: g}, g++)
            });
            a.totalStacks = g + 1;
            return a
        };
        v.prototype.get3dFrame = function () {
            var g = this,
                k = g.options.chart.options3d, a = k.frame, f = g.plotLeft, q = g.plotLeft + g.plotWidth, h = g.plotTop,
                m = g.plotTop + g.plotHeight, e = k.depth, c = function (a) {
                    a = b.shapeArea3d(a, g);
                    return .5 < a ? 1 : -.5 > a ? -1 : 0
                }, w = c([{x: f, y: m, z: e}, {x: q, y: m, z: e}, {x: q, y: m, z: 0}, {x: f, y: m, z: 0}]),
                l = c([{x: f, y: h, z: 0}, {x: q, y: h, z: 0}, {x: q, y: h, z: e}, {x: f, y: h, z: e}]),
                r = c([{x: f, y: h, z: 0}, {x: f, y: h, z: e}, {x: f, y: m, z: e}, {x: f, y: m, z: 0}]),
                d = c([{x: q, y: h, z: e}, {x: q, y: h, z: 0}, {x: q, y: m, z: 0}, {x: q, y: m, z: e}]),
                v = c([{x: f, y: m, z: 0}, {x: q, y: m, z: 0}, {x: q, y: h, z: 0}, {x: f, y: h, z: 0}]), c = c([{
                    x: f,
                    y: h, z: e
                }, {x: q, y: h, z: e}, {x: q, y: m, z: e}, {x: f, y: m, z: e}]), t = !1, B = !1, u = !1, z = !1;
            [].concat(g.xAxis, g.yAxis, g.zAxis).forEach(function (a) {
                a && (a.horiz ? a.opposite ? B = !0 : t = !0 : a.opposite ? z = !0 : u = !0)
            });
            var x = function (a, c, d) {
                for (var e = ["size", "color", "visible"], b = {}, l = 0; l < e.length; l++) for (var f = e[l], k = 0; k < a.length; k++) if ("object" === typeof a[k]) {
                    var m = a[k][f];
                    if (void 0 !== m && null !== m) {
                        b[f] = m;
                        break
            ...
            "auto" === k.axisLabelPosition ? (d = function (a, c) {
                    ...
                    z: 0,
                    xDir: {x: 1, y: 0, z: 0}
                }), d(a.left, a.back) && k.push({y: (h + m) / 2, x: f, z: e, xDir: {x: 0, y: 0, z: -1}}),
                ...
                a.axes = {
                    ...
                    x: {top: {y: h, z: 0, xDir: {x: 1, y: 0, z: 0}}, bottom: {y: m, z: 0, xDir: {x: 1, y: 0, z: 0}}},
                    z: {
                        top: {x: u ? q : f, y: h, xDir: u ? {x: 0, y: 0, z: 1} : {x: 0, y: 0, z: -1}},
        ...
        b.Fx.prototype.matrixSetter = function () {
            ...
            if (1 > this.pos && (b.isArray(this.start) || b.isArray(this.end))) {
                var k = this.start || [1, 0, 0, 1, 0, 0], a = this.end || [1, 0, 0, 1, 0, 0];
                g = [];
    ...
    A(u, "parts-3d/Axis.js", [u["parts/Globals.js"]], function (b) {
        function u(e, c, b) {
            ...
            var l = e.chart, k = y * l.options.chart.options3d.alpha, d = y * l.options.chart.options3d.beta,
                m = a(b && e.options.title.position3d, e.options.labels.position3d);
            b = a(b && e.options.title.skew3d, e.options.labels.skew3d);
            var g = l.frame3d, h = l.plotLeft, w = l.plotWidth + h, q = l.plotTop, n = l.plotHeight + q, l = !1, r = 0,
                v = 0, t = {x: 0, y: 1, z: 0};
            c = e.swapZ({
                x: c.x,
                y: c.y, z: 0
            ...
            "chart" !== m && ("flap" === m ? e.horiz ? (d = Math.sin(k), k = Math.cos(k), e.opposite && (d = -d), l && (d = -d), t = {
                ...
                y: k,
                z: -h.x * d
            }) : h = {x: Math.cos(d), y: 0, z: Math.sin(d)} : "ortho" === m ? e.horiz ? (t =
                Math.cos(k), m = Math.sin(d) * t, k = -Math.sin(k), d = -t * Math.cos(d), t = {
                x: h.y * d - h.z * k,
                y: h.z * m - h.x * d,
                z: h.x * k - h.y * m
                ...
                y: k * t.y,
                z: k * t.z
            }) : h = {x: Math.cos(d), y: 0, z: Math.sin(d)} : e.horiz ? t = {
                x: Math.sin(d) * Math.sin(k),
                y: Math.cos(k),
                z: -Math.cos(d) * Math.sin(k)
            } : h = {x: Math.cos(d), y: 0, z: Math.sin(d)});
            c.x += r * h.x + v * t.x;
            c.y += r * h.y + v * t.y;
            c.z += r * h.z + v * t.z;
            l = p([c], e.chart)[0];
            b && (0 > f(p([c, {x: c.x + h.x, y: c.y + h.y, z: c.z + h.z}, {
                x: c.x + t.x,
                y: c.y + t.y,
                z: c.z + t.z
            }], e.chart)) && (h = {
                x: -h.x,
                y: -h.y, z: -h.z
            }), e = p([{x: c.x, y: c.y, z: c.z}, {x: c.x + h.x, y: c.y + h.y, z: c.z + h.z}, {
                x: c.x + t.x,
                y: c.y + t.y,
                z: c.z + t.z
        ...
        var x, v = b.addEvent, r = b.Axis, n = b.Chart, y = b.deg2rad, g = b.extend, t = b.merge, p = b.perspective,
            k = b.perspective3D, a = b.pick, f = b.shapeArea, q = b.splat, h = b.Tick, m = b.wrap;
        ...
        m(r.prototype, "getPlotBandPath", function (a) {
            ...
            var c = arguments, e = c[2], b = [], c = this.getPlotLinePath({value: c[1]}),
                e = this.getPlotLinePath({value: e});
            if (c && e) for (var f = 0; f < c.length; f += 6) b.push("M", c[f + 1], c[f + 2], "L", c[f + 4], c[f +
            5], "L", e[f + 4], e[f + 5], "L", e[f + 1], e[f + 2], "Z");
            return b
        });
        ...
        m(r.prototype, "getSlotWidth", function (b, c) {
            if (this.chart.is3d() && c && c.label && this.categories && this.chart.frameShapes) {
                var e = this.chart, f = this.ticks, h = this.gridGroup.element.childNodes[0].getBBox(),
                ...
                0 !== g && n && n.label.xy && (m = k({x: n.label.xy.x, y: n.label.xy.y, z: null}, e, e.vd));
                f && f.label.xy && (q = k({x: f.label.xy.x, y: f.label.xy.y, z: null}, e, e.vd));
    ...
    A(u, "parts-3d/Column.js", [u["parts/Globals.js"]], function (b) {
        ...
        function x(b, a, f) {
            ...
            b.call(this, a, f);
            g && (this.options.inactiveOtherPoints =
                !1)
        }
        ...
        g.column.prototype.translate3dShapes = function () {
            ...
            b.data.forEach(function (e) {
                ...
                if (null !== e.y) {
                    var c = e.shapeArgs, f = e.tooltipPos, k;
                    [["x", "width"], ["y", "height"]].forEach(function (a) {
                        k = c[a[0]] - m;
                        0 > k && (c[a[1]] += c[a[0]] + m, c[a[0]] =
                            -m, k = 0);
        ...
        p(g.column.prototype, "animate", function (b) {
            if (this.chart.is3d()) {
                var a = arguments[1], f = this.yAxis, g = this, h = this.yAxis.reversed;
        ...
        p(g.column.prototype, "plotGroup", function (b, a, f, g, h, m) {
            ...
            delete this[a], m && (this.chart.columnGroup || (this.chart.columnGroup = this.chart.renderer.g("columnGroup").add(m)), this[a] = this.chart.columnGroup, this.chart.columnGroup.attr(this.getPlotBox()), this[a].survive = !0, "group" === a || "markerGroup" === a)) && (arguments[3] = "visible");
        ...
        p(y.prototype, "alignDataLabel", function (b) {
            if (this.chart.is3d() && this instanceof g.column) {
                var a = arguments, f = a[4], a =
                    a[1], k = {x: f.x, y: f.y, z: this.z}, k = r([k], this.chart, !0)[0];
                f.x = k.x;
        ...
        p(b.StackItem.prototype, "getStackBox", function (g, a) {
            ...
            if (a.is3d()) {
                var k = {x: f.x, y: f.y, z: 0}, k = b.perspective([k], a, !0)[0];
                f.x = k.x;
                f.y = k.y
            }
            return f
    ...
    A(u, "parts-3d/Pie.js", [u["parts/Globals.js"]], function (b) {
        ...
        b(v.pie.prototype, "translate", function (b) {
            ...
            if (this.chart.is3d()) {
                var n = this, g = n.options, t = g.depth || 0, p = n.chart.options.chart.options3d, k = p.alpha,
        ...
        b(v.pie.prototype, "drawDataLabels", function (b) {
            if (this.chart.is3d()) {
                ...
                this.data.forEach(function (b) {
                    var g = b.shapeArgs,
                        p = g.r, k = (g.start + g.end) / 2;
                    b = b.labelPosition;
                    var a = b.connectorPosition, f = -p * (1 - Math.cos((g.alpha || n.alpha) * u)) * Math.sin(k),
        ...
        b(v.pie.prototype, "animate", function (b) {
            if (this.chart.is3d()) {
                var n = arguments[1],
                    g = this.options.animation, t = this.center, p = this.group, k = this.markerGroup;
    ...
    A(u, "parts-3d/Scatter.js", [u["parts/Globals.js"]], function (b) {
        var u =
            b.Point, x = b.seriesType, v = b.seriesTypes;
    ...
    A(u, "parts-3d/VMLRenderer.js", [u["parts/Globals.js"]], function (b) {
        ...
        r && (b.setOptions({animate: !1}), r.prototype.face3d = v.prototype.face3d, r.prototype.polyhedron = v.prototype.polyhedron, r.prototype.elements3d = v.prototype.elements3d, r.prototype.element3d = v.prototype.element3d, r.prototype.cuboid = v.prototype.cuboid, r.prototype.cuboidPath = v.prototype.cuboidPath, r.prototype.toLinePath = v.prototype.toLinePath,
            r.prototype.toLineSegments = v.prototype.toLineSegments, r.prototype.arc3d = function (b) {
            ...
            this.backFrame && (this.backFrame.css({zIndex: 0}),
