...
(function (a) {
    ...
    c(a, "mixins/derived-series.js", [a["parts/Globals.js"]], function (b) {
        ...
        return {
            ...
            init: function () {
                ...
                this.eventRemovers = [];
                this.addEvents()
            }, setDerivedData: b.noop, setBaseSeries: function () {
                var a = this.chart, h = this.options.baseSeries;
    ...
    c(a, "modules/histogram.src.js", [a["parts/Globals.js"], a["mixins/derived-series.js"]], function (a, c) {
        ...
        var m = a.objectEach,
            h = a.seriesType, e = a.correctFloat, n = a.isNumber, p = a.arrayMax, r = a.arrayMin;
        a = a.merge;
        var d = {
        ...
        h("histogram", "column", {
            ...
            a(c, {
                setDerivedData: function () {
                    ...
                    m(g, function (a,
                                   b) {
                        h.push({x: Number(b), y: a, x2: e(Number(b) + d)})
                    });
                    h.sort(function (a, b) {
                        return a.x - b.x
                    });
                    ...
                    var a = this.options.binsNumber, b = d[a] || "function" === typeof a && a;
    ...
    c(a, "modules/bellcurve.src.js", [a["parts/Globals.js"], a["mixins/derived-series.js"]], function (a, c) {
        ...
        var e = a.seriesType, n = a.correctFloat, p = a.isNumber;
        a = a.merge;
        e("bellcurve", "areaspline", {intervals: 3, pointsInInterval: 3, marker: {enabled: !1}}, a(c, {
            setMean: function () {
                ...
                1 < this.baseSeries.yData.length &&
                (this.setMean(), this.setStandardDeviation(), this.setData(this.derivedData(this.mean, this.standardDeviation), !1))
            }, derivedData: function (a, b) {
                var f = this.options.intervals, c = this.options.pointsInInterval, d = a - f * b, f = f * c * 2 + 1,
                    c = b / c, e = [], g;
