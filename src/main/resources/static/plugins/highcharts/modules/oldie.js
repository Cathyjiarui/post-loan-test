...
(function (f) {
    ...
    k(f, "modules/oldie.src.js", [f["parts/Globals.js"]], function (d) {
        ...
        f = d.extendClass;
        var K = d.isArray, H = d.isNumber, z = d.isObject, L = d.merge, I = d.noop, A = d.pick, q = d.pInt, C = d.svg,
            x = d.SVGElement, u = d.SVGRenderer, v = d.win;
        d.getOptions().global.VMLRadialGradientURL = "http://highcharts.highcharts.com/7.1.2/gfx/vml-radial-gradient.png";
        ...
        C || (d.addEvent(x, "afterInit", function () {
            ...
            docMode8: g && 8 === g.documentMode, init: function (a, b) {
                ...
                var b = this.renderer, c = this.element, e = b.box, n = a && a.inverted, e = a ? a.element || a : e;
