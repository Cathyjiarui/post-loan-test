...
seriesType(
     ...
     */
    {
         ...
         * if joinBy is "highcharts", the mapData items with a specific highcharts is merged
         * into the data with the same highcharts. For maps loaded from GeoJSON, the
