...
(function (factory) {
        ...
        // Prototype members
            ...
            translate: function () {
                ...
                for (i = 0, len = points.length; i < len; i++) {
                    ...
                    // highcharts responsible for correct positions of stacked points
                    // starts here
                    if (stacking) {
                        if (actualStack) {
            ...
            setStackedPoints: function () {
                ...
                // highcharts responsible for creating stacks for waterfall series
    ...
    _registerModule(_modules, 'parts-more/BubbleLegend.js', [_modules['parts/Globals.js']], function (H) {
        ...
        H.BubbleLegend.prototype = {
             ...
             * used highcharts from BubbleSeries.js 'getRadius' method.
             *
             * @private
        ...
        addEvent(Chart, 'render', function () {
            ...
            function layoutStep(layout) {
                if (
                    ...
                    // It's faster which is important for rAF highcharts.
