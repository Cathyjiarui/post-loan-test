...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/dark-green", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/dark-green.js", [a["parts/Globals.js"]], function (a) {
        a.theme = {
            ...
            navigation: {
                buttonOptions: {
                    symbolStroke: "#DDDDDD", hoverSymbolStroke: "#FFFFFF", theme: {
                        fill: {
                            linearGradient: {
                                x1: 0, y1: 0, x2: 0,
                                y2: 1
    ...
    b(a, "masters/themes/dark-green.src.js", [], function () {
    })
});
