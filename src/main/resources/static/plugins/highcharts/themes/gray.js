...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/gray", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/gray.js", [a["parts/Globals.js"]], function (a) {
        a.theme = {
            ...
            chart: {
                ...
                }, borderWidth: 0, borderRadius: 0, plotBackgroundColor: null, plotShadow: !1, plotBorderWidth: 0
            },
            title: {
                style: {
                    color: "#FFF",
            ...
            legend: {
                itemStyle: {color: "#CCC"},
                itemHoverStyle: {color: "#FFF"}, itemHiddenStyle: {color: "#333"}
            },
    ...
    b(a, "masters/themes/gray.src.js", [], function () {
    })
});
