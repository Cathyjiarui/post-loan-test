...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/grid-light", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/grid-light.js", [a["parts/Globals.js"]], function (a) {
    ...
    b(a, "masters/themes/grid-light.src.js", [], function () {
    })
});
