...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/sand-signika", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/sand-signika.js", [a["parts/Globals.js"]], function (a) {
    ...
    b(a, "masters/themes/sand-signika.src.js",
        [], function () {
        })
});
