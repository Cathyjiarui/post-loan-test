...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/dark-blue", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/dark-blue.js", [a["parts/Globals.js"]], function (a) {
        a.theme = {
    ...
    b(a, "masters/themes/dark-blue.src.js", [], function () {
    })
});
