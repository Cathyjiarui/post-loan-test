...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/grid", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    a = a ? a._modules : {};
    b(a, "themes/grid.js", [a["parts/Globals.js"]], function (a) {
        a.theme = {
            ...
            chart: {
                ...
                }, borderWidth: 2, plotBackgroundColor: "rgba(255, 255, 255, .9)", plotShadow: !0, plotBorderWidth: 1
            },
    ...
    b(a, "masters/themes/grid.src.js", [], function () {
    })
});
