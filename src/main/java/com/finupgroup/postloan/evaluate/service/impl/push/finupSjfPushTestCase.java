...
/**
 * @ClassName finupSjfPushTestCase
 * @Description 速金服案件推送
 * @Author JiaZhang
 * @Date 2019/11/19
 * @Version 1.0
 **/
@Repository
public class finupSjfPushTestCase implements pushTestCase {
    ...
    public String pushCase(String url, OverDueVo overDueVo, String serviceCode) {
        ...
        baseVO.getCaseVo().setChannelId(74L);
        baseVO.getCaseVo().setProductName("SJF-APP");
