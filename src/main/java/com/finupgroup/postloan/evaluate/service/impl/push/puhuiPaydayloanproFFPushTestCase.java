...
/**
 * @ClassName puhuiPaydayloanproFFPushTestCase
 * @Description TODO
 * @Author JiaZhang
 * @Date 2019/11/19
 * @Version 1.0
 **/
@Repository
public class puhuiPaydayloanproFFPushTestCase implements pushTestCase {
    ...
    public String pushCase(String url, OverDueVo overDueVo, String serviceCode) {
        ...
        baseVO.getCaseVo().setChannelId(77L);
        baseVO.getCaseVo().setProductName("puhui_paydayloanpro_ff");
