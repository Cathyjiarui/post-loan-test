...
/**
 * @ClassName finupAibtproPushTestCase
 * @Description 爱白条大额案件推送
 * @Author JiaZhang
 * @Date 2019/11/19
 * @Version 1.0
 **/
@Repository
public class finupAibtproPushTestCase implements pushTestCase {
    ...
    public String pushCase(String url, OverDueVo overDueVo, String serviceCode) {
        ...
        baseVO.getCaseVo().setChannelId(78L);
        baseVO.getCaseVo().setProductName("finup_aibtpro");
